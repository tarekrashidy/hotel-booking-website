  ...
  return (
    <div>
      <div className="container my-24 px-6 mx-auto">
        ...
        <section className="mb-24 text-base-100 bg-gradient-to-l from-green-300 to-green-800 rounded-lg">
            ...
            <div className="container mx-auto">
              <div className="grid lg:grid-cols-2 gap-12 flex items-center">
                <div className="mt-12 lg:mt-0">
                  <h1 className="text-5xl md:text-6xl font-extrabold leading-tighter tracking-tighter mb-4 aos-init aos-animate" data-aos="zoom-y-out">A whole world of hotels
                    <span className="bg-clip-text text-transparent bg-gradient-to-r from-yellow-600 to-yellow-400"> .wonderful</span></h1>
                  <p className="text-xl">
                  ...
                  <p className="text-xl">
                    ...
                    <NavLink  to="/login" >
                    <button className="btn my-4  border-0 bg-gradient-to-r from-yellow-600 to-yellow-400  text-base-100">
 Login 
                ...
                <div className="mb-12 lg:mb-0 xl:max-w-lg mx-auto">
        ...
        <section className="mb-32 text-gray-800 text-center">
          ...
          <div className="flex justify-center">
            <div className="max-w-[800px]">
              <h2 className="text-5xl md:text-6xl xl:text-7xl font-bold tracking-tight mb-12   text-slate-900    ">
                Are you ready <br />
        ...
        <section className="mb-32 text-gray-800 text-center md:text-left">
          ...
          <h2 className="text-3xl font-bold mb-12 text-center text-slate-900 ">Plan your best trip ever</h2>
          ...
          <div className="grid md:grid-cols-2 gap-x-6 xl:gap-x-12 items-center mb-12">
            <div className="mb-6 md:mb-0">
              <div
                ...
                <img src={California}
                  className="w-full  relative overflow-hidden bg-no-repeat bg-cover ripple shadow-lg rounded-lg   transition duration-300 ease-in-out mx-auto" alt="Louvre" />

              </div>
            </div>

            <div className="mb-6 md:mb-0">
              <h3 className="text-2xl font-bold mb-3 text-slate-900 ">Welcome to California</h3>
          ...
          <div className="grid md:grid-cols-2 gap-x-6 xl:gap-x-12 items-center mb-12">
            <div className="mb-6 md:mb-0 md:order-2">
              <div
                ...
                data-mdb-ripple="true" data-mdb-ripple-color="light">
                <img src={Paris}
                  className="ww-full  relative overflow-hidden bg-no-repeat bg-cover ripple shadow-lg rounded-lg   transition duration-300 ease-in-out mx-auto" alt="Louvre" />

              </div>
            </div>

            <div className="mb-6 md:mb-0 md:order-1">
              <h3 className="text-2xl font-bold mb-3 text-slate-900 ">Exhibition in Paris</h3>
          ...
          <div className="grid md:grid-cols-2 gap-x-6 xl:gap-x-12 items-center mb-12">
            ...
            <div className="mb-6 md:mb-0">
              <h3 className="text-2xl font-bold mb-3 text-slate-900 ">Investing in Travel and Tourism Stocks</h3>
